...
//                 // Use the user's current location as the initial map center and marker position
...
//     const map = autocompletes.find(ac => ac.key === key).map;
//     const marker = autocompletes.find(ac => ac.key === key).marker;
