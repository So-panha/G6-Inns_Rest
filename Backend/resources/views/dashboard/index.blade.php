            ...
            <div class="bg-white rounded shadow p-4 mb-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <button class="bg-red-500 hover:bg-red-700 text-white py-2 px-6 rounded ml-auto" onclick="changeColor(this)">Confirm</button>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="fixed inset-0 bg-black bg-opacity-60 flex justify-center hidden" id="detailModal">
        <div class="bg-white rounded-lg p-10 w-3/4">
            <div class="flex items-center justify-between">
                ...
                <button type="button" class="text-gray-700 hover:text-gray-900" onclick="closeDetailModal()">&times;</button>
            </div>
            <hr class="my-4">
            <div id="modalContent">
