        ...
        <div class="w-72">
          ...
          <form class="mt-4" @submit.prevent="onSubmit">
            ...
            <div class="mb-3 flex flex-wrap content-center">
              <router-link class="nav-link active inline-flex items-center text-xs font-semibold text-purple-700"
                aria-current="page" to="/reset">
                Forgot password?
              </router-link>
            </div>
