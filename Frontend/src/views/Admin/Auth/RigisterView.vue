<template>
    <div
      class="flex bg-white rounded-lg shadow-2xl border-4 border-gray-200 overflow-hidden mx-auto max-w-sm lg:max-w-4xl mt-48"
    >
      <div class="w-full p-8 lg:w-1/2">
        ...
        <form @submit.prevent="register">
          <div class="mb-4">
            ...
            />
            <span v-if="shouldMarkError('name')" class="text-red-500 text-sm">{{
              errors.name
            }}</span>
          </div>
          <div class="mb-4">
