...
const getUserProfile = async () => {
  try {
    const response = await axios.get('http://127.0.0.1:8000/api/user/show/4}'); // Adjust URL and user ID as needed
...
const updateUser = async () => {
  ...
  try {
    const response = await axios.post('http://127.0.0.1:8000/api/user/update/4', formData, {
